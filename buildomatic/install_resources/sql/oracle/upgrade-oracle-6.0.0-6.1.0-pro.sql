...
ALTER TABLE JIProfileAttribute ADD description nvarchar2(255);
ALTER TABLE JIProfileAttribute MODIFY attrValue nvarchar2(2000) NULL;
ALTER TABLE JIProfileAttribute ADD owner nvarchar2(255);

ALTER TABLE JICustomDatasourceProperty MODIFY name nvarchar2(200);

ALTER TABLE JICustomDatasourceResource MODIFY name nvarchar2(200);

ALTER TABLE JIResource MODIFY name nvarchar2(200);
ALTER TABLE JIResource MODIFY label nvarchar2(200);

ALTER TABLE JIResourceFolder MODIFY name nvarchar2(200);
ALTER TABLE JIResourceFolder MODIFY label nvarchar2(200);

ALTER TABLE JIVirtualDataSourceUriMap MODIFY data_source_name nvarchar2(200);

ALTER TABLE JIDomainDatasourceDSRef MODIFY alias nvarchar2(200);
