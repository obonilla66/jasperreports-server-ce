...
UPDATE currency SET "DATE" = add_months("DATE",252);
UPDATE promotion SET start_date = add_months(start_date,252);
UPDATE expense_fact SET exp_date = add_months(exp_date,252);
UPDATE agg_g_ms_pcat_sales_fact_1997 SET the_year = add_months(the_year,252);
UPDATE time_by_day SET the_date = add_months(the_date,252);
UPDATE time_by_day SET the_year = the_year + 21;
UPDATE reserve_employee SET hire_date = add_months(hire_date,252);
UPDATE employee SET hire_date = add_months(hire_date,252);
...
UPDATE store SET first_opened_date = add_months(first_opened_date,180);
UPDATE store SET last_remodel_date = add_months(last_remodel_date,180);
UPDATE store_ragged SET first_opened_date = add_months(first_opened_date,180);
UPDATE store_ragged SET last_remodel_date = add_months(last_remodel_date,180);
