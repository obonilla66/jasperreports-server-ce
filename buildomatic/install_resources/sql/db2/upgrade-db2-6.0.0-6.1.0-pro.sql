...
ALTER TABLE JIProfileAttribute ADD COLUMN description varchar(765);
ALTER TABLE JIProfileAttribute ALTER COLUMN attrValue SET DATA TYPE varchar(6000);
ALTER TABLE JIProfileAttribute ALTER COLUMN attrValue DROP NOT NULL;
ALTER TABLE JIProfileAttribute ADD COLUMN owner varchar(765);
CALL SYSPROC.ADMIN_CMD('REORG TABLE JIProfileAttribute');

ALTER TABLE JICustomDatasourceProperty ALTER COLUMN name SET DATA TYPE varchar(600);
ALTER TABLE JICustomDatasourceProperty ALTER COLUMN name SET NOT NULL;
CALL SYSPROC.ADMIN_CMD('REORG TABLE JICustomDatasourceProperty');

ALTER TABLE JICustomDatasourceResource ALTER COLUMN name SET DATA TYPE varchar(600);
ALTER TABLE JICustomDatasourceResource ALTER COLUMN name SET NOT NULL;
CALL SYSPROC.ADMIN_CMD('REORG TABLE JICustomDatasourceResource');

ALTER TABLE JIResource ALTER COLUMN name SET DATA TYPE varchar(600);
ALTER TABLE JIResource ALTER COLUMN name SET NOT NULL;
ALTER TABLE JIResource ALTER COLUMN label SET DATA TYPE varchar(600);
ALTER TABLE JIResource ALTER COLUMN label SET NOT NULL;
CALL SYSPROC.ADMIN_CMD('REORG TABLE JIResource');

ALTER TABLE JIResourceFolder ALTER COLUMN name SET DATA TYPE varchar(600);
ALTER TABLE JIResourceFolder ALTER COLUMN name SET NOT NULL;
ALTER TABLE JIResourceFolder ALTER COLUMN label SET DATA TYPE varchar(600);
ALTER TABLE JIResourceFolder ALTER COLUMN label SET NOT NULL;
CALL SYSPROC.ADMIN_CMD('REORG TABLE JIResourceFolder');

ALTER TABLE JIVirtualDataSourceUriMap ALTER COLUMN data_source_name SET DATA TYPE varchar(600);
ALTER TABLE JIVirtualDataSourceUriMap ALTER COLUMN data_source_name SET NOT NULL;
CALL SYSPROC.ADMIN_CMD('REORG TABLE JIVirtualDataSourceUriMap');

ALTER TABLE JIDomainDatasourceDSRef ALTER COLUMN alias SET DATA TYPE varchar(600);
ALTER TABLE JIDomainDatasourceDSRef ALTER COLUMN alias SET NOT NULL;
CALL SYSPROC.ADMIN_CMD('REORG TABLE JIDomainDatasourceDSRef');
