...
ALTER TABLE JIProfileAttribute ADD description nvarchar(255);
ALTER TABLE JIProfileAttribute ALTER COLUMN attrValue nvarchar(2000) NULL;
ALTER TABLE JIProfileAttribute ADD owner nvarchar(255);

ALTER TABLE JICustomDatasourceProperty ALTER COLUMN name nvarchar(200) NOT NULL;

ALTER TABLE JICustomDatasourceResource ALTER COLUMN name nvarchar(200) NOT NULL;

ALTER TABLE JIResource ALTER COLUMN name nvarchar(200) NOT NULL;
ALTER TABLE JIResource ALTER COLUMN label nvarchar(200) NOT NULL;

ALTER TABLE JIResourceFolder ALTER COLUMN name nvarchar(200) NOT NULL;
ALTER TABLE JIResourceFolder ALTER COLUMN label nvarchar(200) NOT NULL;

ALTER TABLE JIVirtualDataSourceUriMap ALTER COLUMN data_source_name nvarchar(200) NOT NULL;

ALTER TABLE JIDomainDatasourceDSRef ALTER COLUMN alias nvarchar(200) NOT NULL;
