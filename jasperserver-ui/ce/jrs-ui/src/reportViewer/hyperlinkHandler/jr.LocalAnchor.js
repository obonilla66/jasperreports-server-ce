...
import $ from 'jquery';
var LocalAnchor = function (arrHyperlinks) {
    this.hyperlinks = arrHyperlinks;
    this.reportInstance = null;
    this.reportContainer = null;
};
LocalAnchor.prototype = {
    register: function () {
        var it = this;
    ...
    _handleHyperlinkClick: function (hyperlink) {
        var it = this, href = hyperlink.href, pageIndex = href && href.indexOf('pageIndex') != -1 ? /pageIndex=(\d*)/.exec(href)[1] : '', anchor;
