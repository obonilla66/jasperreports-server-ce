...
import itemViewTemplate from '../templates/itemViewTemplate.htm';
...
var ResetSettingsItemView = BaseRow.extend({
    ...
    behaviors: _.extend(BaseRow.prototype.behaviors, {DeleteConfirm: {behaviorClass: DeleteConfirm}})
});
export default ResetSettingsItemView;