...
import TextDataSourceModel from './TextDataSourceModel';
...
import textBackboneTemplate from './template/backboneTemplate.htm';
import textFileLocationTemplate from './template/fileLocationTemplate.htm';
import textFilePropertiesTemplate from './template/filePropertiesTemplate.htm';
...
export default CustomDataSourceView.extend({
    ...
    adjustPreviewButton: function () {
        ...
        var flag3 = this.model.get('fileSourceType') === 'ftpServer' && this.model.isValid([
            'serverAddress',
            'serverPath',
            'ftpsPort'
        ]);
