...
import ListWithSelection from 'src/common/component/list/view/ListWithSelection';
...
describe("ListWithSelection", function () {
    ...
    it("click on item should select it", function(){
        ...
        expect(firstUl.hasClass("selected")).toBeTruthy();
    });
    ...
    it("click on item of disabled component should not select it", function(){
        ...
        expect(firstUl.hasClass("selected")).toBeFalsy();
    });

    /* Commented out since behaviour change, see next tests*/
    /*it("click on selected item with CTRL key to deselect it", function(){
        list = new ListWithSelection(_.extend({
            value: {0: "1"}
        }, defaultConstructorParameters));
    ...
    it("click on selected item with CTRL key to deselect all other items and remain that item selected", function(){
        ...
        expect(firstUl.hasClass("selected")).toBeTruthy();
        expect(list.$el.find("li:eq(1)").hasClass("selected")).toBeFalsy();
    });
    ...
    it("click one element and on other with SHIFT or COMMAND to select range", function(){
        ...
        expect(list.$el.find("li:eq(0)").hasClass("selected")).toBeTruthy();
    });

    /* Commented out since behaviour changed */
    /*it("click one element should clear all other selected elements", function(){
        list = new ListWithSelection(defaultConstructorParameters);
        ...
        //Select something in the middle withour shift
        ...
        expect(selection).toBeDefined();
        expect(selection.length).toEqual(1);
        expect(selection[0]).toEqual("11");

        expect(list.$el.find("li:eq(10)").hasClass("selected")).toBeTruthy();
        expect(list.$el.find("li:eq(0)").hasClass("selected")).toBeFalsy();
        expect(list.$el.find("li:eq(50)").hasClass("selected")).toBeFalsy();
    });*/
    ...
    it("click one element should toggle this element and do not clear all other selected elements", function(){
        ...
        //Select something in the middle without shift
        var middleUl = list.$el.find("li:eq(10)");
        ...
        expect(list.$el.find("li:eq(10)").hasClass("selected")).toBeFalsy();
        expect(list.$el.find("li:eq(0)").hasClass("selected")).toBeTruthy();
        expect(list.$el.find("li:eq(50)").hasClass("selected")).toBeTruthy();
    });

    it("set empty value also should fire selection:change event", function(done){
        list = new ListWithSelection(defaultConstructorParameters());
