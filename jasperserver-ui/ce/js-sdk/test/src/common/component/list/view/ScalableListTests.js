...
describe("ScalableList", function () {
    ...
    it("should keep scroll position on fetch if keepPosition parameter provided", function(){
        var resetSpy = sinon.spy(list, "reset"),
            modelFetchSpy = sinon.spy(model, "fetch"),
            renderDataStub = sinon.stub(list, "renderData"),
            scrollTopStub = sinon.stub(list.$el, "scrollTop"),
