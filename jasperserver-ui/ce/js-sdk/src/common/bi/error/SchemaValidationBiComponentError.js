...
export default BiComponentError.extend({
    constructor: function (validationError) {
        ...
        BiComponentError.prototype.constructor.call(this, errorCodes.SCHEMA_VALIDATION_ERROR, messages[errorCodes.SCHEMA_VALIDATION_ERROR] + ': ' + propertyName + ': ' + this.validationError.message, [
