...
export default {
    ...
    UNSUPPORTED_CONFIGURATION_ERROR: 'unsupported.configuration.error',
    AUTHENTICATION_ERROR: 'authentication.error',
    AUTHORIZATION_ERROR: 'authorization.error',
    CONTAINER_NOT_FOUND_ERROR: 'container.not.found.error',
    WRONG_CONTAINER_SIZE_ERROR: 'wrong.container.size.error',
    REPORT_EXECUTION_FAILED: 'report.execution.failed',
    ...
    AD_HOC_VIEW_RENDER_ERROR: 'ad.hoc.view.render.error'
};
