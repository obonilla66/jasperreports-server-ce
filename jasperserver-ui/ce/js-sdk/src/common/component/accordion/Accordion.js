...
Accordion.prototype.fit = function () {
    var collapsedPanels = [], nonCollapsedPanels = [];
    _.each(this.panels, function (panel) {
        panel.collapsed ? collapsedPanels.push(panel) : nonCollapsedPanels.push(panel);
    });
    var collapsedPanelsTotalHeight = 0, containerHeight = $(this.container).height(), freeHeightToShare = 0, fixedHeightPanelsNumber = 0;
