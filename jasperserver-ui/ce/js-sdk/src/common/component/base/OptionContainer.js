...
export default Backbone.View.extend(/** @lends OptionContainer.prototype */{
    events: {
        "mouseout": "_mouseout",
    ...
    setElement: function(el){
        ...
        this.$contentContainer = this.contentContainer
            ? this.$(this.contentContainer).addBack().filter(this.contentContainer) : this.$el;
        return res;
    },
    ...
    render: function() {
        ...
        this.collection.forEach(function(optionModel) {
            ...
            self.listenTo(view, "mouseover", function(option, _ignored, ev) {
                /**
            ...
            self.listenTo(view, "mouseout", function(option, _ignored, ev) {
                /**
