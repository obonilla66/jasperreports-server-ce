...
var groupMenuTrait = {
    _onInitialize: function () {
        var $items = this.$contentContainer.find('li'), GROUP_PROPERTY_NAME = 'groupId', groupNames = this._getGroupNames(this.collection.models, GROUP_PROPERTY_NAME);
