...
var TooltipPopupView = Backbone.View.extend({
    ...
    render: function () {
        var $mTooltip = this.$el.find('.jr-mTooltip'), $jTooltipText = this.$el.find('.jr-jTooltipText'), $jTooltipLabel = this.$el.find('.jr-jTooltipLabel');
        ...
        if (this.model.hasChanged('placement')) {
            var prevPlacement = capitalize(this.model.previousAttributes().placement), newPlacement = capitalize(this.model.get('placement'));
...
export default TooltipPopupView;