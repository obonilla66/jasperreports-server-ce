 ...
 */
public class NotNullConstraintValidationErrorDescriptorBuilderTest {
    private NotNullConstraintValidationErrorDescriptorBuilder builder = new NotNullConstraintValidationErrorDescriptorBuilder();
