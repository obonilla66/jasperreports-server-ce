 ...
 */
@Service
public class BsonObjectIdDataConverter implements DataConverter<ObjectId> {
    @Override
    public ObjectId stringToValue(String rawData) throws Exception {
        return InputControlHandler.NULL_SUBSTITUTION_VALUE.equals(rawData) ? null : new ObjectId(rawData);
    }
