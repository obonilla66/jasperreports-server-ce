...
public class AwsDataSourceServiceImplTest {
    ...
    public void getAwsDBInstances_noRdsInstances_returnEmptyStatus() {
        ...
        doReturn(DATA_SOURCE_AWS_EMPTY).when(messageSource).getMessage(ArgumentMatchers.eq(DATA_SOURCE_AWS_EMPTY),
                ArgumentMatchers.any(String[].class), ArgumentMatchers.any(Locale.class));
    ...
    public void getAwsDBInstances_accessDenied_returnAccessDeniedStatus() {
        ...
        doReturn("resource.dataSource.aws.access.denied").when(messageSource).getMessage(ArgumentMatchers.eq("resource.dataSource.aws.access.denied"),
                ArgumentMatchers.any(String[].class), ArgumentMatchers.any(Locale.class));
    ...
    public void getAwsDBInstances_unknownHost_returnUnknownHostStatus() {
        ...
        doReturn("resource.dataSource.aws.unknown.host").when(messageSource).getMessage(ArgumentMatchers.eq("resource.dataSource.aws.unknown.host"),
                ArgumentMatchers.any(String[].class), ArgumentMatchers.any(Locale.class));
    ...
    public void getAwsDBInstances_anyAmazonServiceException_returnErrorStatus() {
        ...
        doReturn("[" + amazonServiceException.getMessage() + "]").when(messageSource).getMessage(ArgumentMatchers.eq("[" + amazonServiceException.getMessage() + "]"),
                ArgumentMatchers.any(String[].class), ArgumentMatchers.any(Locale.class));
    ...
    public void getAwsDBInstances_anyAmazonClientException_returnErrorStatus() {
        ...
        doThrow(amazonServiceException).when(awsDataSourceService).getRdsInstances(any(AmazonRDS.class));
        doReturn("[" + exceptionMessage + "]").when(messageSource).getMessage(ArgumentMatchers.eq("[" + exceptionMessage + "]"),
                ArgumentMatchers.any(String[].class), ArgumentMatchers.any(Locale.class));
