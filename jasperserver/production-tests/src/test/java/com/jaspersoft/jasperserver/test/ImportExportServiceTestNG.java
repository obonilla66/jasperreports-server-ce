...
public class ImportExportServiceTestNG extends BaseExportTestCaseTestNG {
    ...
    public void doImport_folderWithSameUriAsExistingResource_expectedWarningMessage() throws Exception {
        ...
        importParams.put("update", Boolean.TRUE.toString());
        importParams.put("include-server-settings", Boolean.TRUE.toString());
        importParams.put("include-access-events", Boolean.TRUE.toString());
        importParams.put("include-audit-events", Boolean.FALSE.toString());
        importParams.put("merge-organization", Boolean.FALSE.toString());
        importParams.put("skip-user-update", Boolean.FALSE.toString());
        importParams.put("include-monitoring-events", Boolean.FALSE.toString());
        importParams.put("skip-themes", Boolean.TRUE.toString());
