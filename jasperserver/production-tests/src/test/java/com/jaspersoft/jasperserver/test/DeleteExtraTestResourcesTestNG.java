...
public class DeleteExtraTestResourcesTestNG extends BaseServiceSetupTestNG {
    ...
    */
	...
	public void deleteExtraTestResources() throws Exception {
        ...
        deleteEncryptionResource();

        // delete samples folder
        getUnsecureRepositoryService().deleteFolder(null, "/reports/samples");
        getUnsecureRepositoryService().deleteFolder(null, "/public/TestEncryption");
        getUnsecureRepositoryService().deleteFolder(null, "/public");
    ...
    private void deleteEncryptionResource() {
        getUnsecureRepositoryService().deleteResource(null, "/public/TestEncryption/AllAccounts");
    }
