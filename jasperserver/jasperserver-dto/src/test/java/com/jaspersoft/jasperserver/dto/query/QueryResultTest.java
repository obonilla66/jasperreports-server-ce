...
public class QueryResultTest extends BaseDTOPresentableTest<QueryResult> {
    ...
    public void instanceCanBeCreatedFromParameters() {
    	List<QueryResultRow> rows = fullyConfiguredTestInstance.getRows();
        QueryResult result = new QueryResult(fullyConfiguredTestInstance.getNames(), rows.toArray(new QueryResultRow[rows.size()]));
