...
class ClientListOfValuesTest extends BaseDTOPresentableTest<ClientListOfValues> {

    private static final List<ClientListOfValuesItem> TEST_ITEMS = Arrays.asList(
            new ClientListOfValuesItem().setLabel("TEST_LABEL"),
            new ClientListOfValuesItem().setValue("TEST_VALUE")
    );
    private static final List<ClientListOfValuesItem> TEST_ITEMS_1 = Arrays.asList(
            new ClientListOfValuesItem().setLabel("TEST_LABEL_1"),
            new ClientListOfValuesItem().setValue("TEST_VALUE_1")
    );
    ...
    @Override
    protected List<ClientListOfValues> prepareInstancesWithAlternativeParameters() {
    ...
    @Override
    protected ClientListOfValues createFullyConfiguredInstance() {
    ...
    @Override
    protected ClientListOfValues createInstanceWithDefaultParameters() {
        return new ClientListOfValues();
    }

    @Override
    protected ClientListOfValues createInstanceFromOther(ClientListOfValues other) {
        return new ClientListOfValues(other);
    }
}