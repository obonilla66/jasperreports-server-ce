...
public class ClientJobCalendarTest extends BaseDTOTest<ClientJobCalendar> {
    ...
    private static final Calendar TEST_EXCLUDE_DAY_2 = TestsValuesProvider.provideCalendarInstance(TEST_TIMEZONE_ID_1, TEST_TIME);
    ...
    private static final ArrayList<Calendar> TEST_EXCLUDE_DAYS_2 = new ArrayList<Calendar>(Collections.singletonList(TEST_EXCLUDE_DAY_2));
    ...
    @Test
    public void testSetExcludeDaysTimeZone() {
        ClientJobCalendar fullyConfiguredInstance = createFullyConfiguredInstance_withDifferentTimeZone();

        assertEquals(fullyConfiguredInstance.getExcludeDays(), TEST_EXCLUDE_DAYS_2);
    }

    protected ClientJobCalendar createFullyConfiguredInstance_withDifferentTimeZone() {
          return createFullyConfiguredInstance().setTimeZone(TEST_TIME_ZONE_1)
                  .setExcludeDaysTimeZone(TEST_EXCLUDE_DAYS);
    }
    /*
     * Preparing
     */
