...
class ClientBeanDataSourceTest extends BaseDTOPresentableTest<ClientBeanDataSource> {

    private static final String TEST_BEAN_METHOD = "TEST_BEAN_METHOD";
    private static final String TEST_BEAN_METHOD_1 = "TEST_BEAN_METHOD_1";

    private static final String TEST_BEAN_NAME = "TEST_BEAN_NAME";
    ...
    @Override
    protected List<ClientBeanDataSource> prepareInstancesWithAlternativeParameters() {
        return Arrays.asList(
                createFullyConfiguredInstance().setBeanMethod(TEST_BEAN_METHOD_1),
                createFullyConfiguredInstance().setBeanName(TEST_BEAN_NAME_1),
                // base class fields (ClientResource)
                ...
                createFullyConfiguredInstance().setBeanMethod(null),
                createFullyConfiguredInstance().setBeanName(null),
                // base class fields (ClientResource)
    ...
    @Override
    protected ClientBeanDataSource createFullyConfiguredInstance() {
        return createInstanceWithDefaultParameters()
                .setBeanMethod(TEST_BEAN_METHOD)
                .setBeanName(TEST_BEAN_NAME)
                // base class fields (ClientResource)
    ...
    @Override
    protected ClientBeanDataSource createInstanceWithDefaultParameters() {
        return new ClientBeanDataSource();
    }

    @Override
    protected ClientBeanDataSource createInstanceFromOther(ClientBeanDataSource other) {
        return new ClientBeanDataSource(other);
    }
