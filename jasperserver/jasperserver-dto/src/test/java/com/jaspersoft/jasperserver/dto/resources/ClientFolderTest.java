...
class ClientFolderTest extends BaseDTOPresentableTest<ClientFolder> {
    ...
    @Override
    protected List<ClientFolder> prepareInstancesWithAlternativeParameters() {
    ...
    @Override
    protected ClientFolder createFullyConfiguredInstance() {
    ...
    @Override
    protected ClientFolder createInstanceWithDefaultParameters() {
        return new ClientFolder();
    }

    @Override
    protected ClientFolder createInstanceFromOther(ClientFolder other) {
        return new ClientFolder(other);
    }
