 ...
 * @version $Id$
 */
@XmlRootElement(name = ClientLess.EXPRESSION_ID)
public class ClientLess extends ClientComparison<ClientLess> {

    public static final String EXPRESSION_ID = "less";
    ...
    public ClientLess(List<ClientExpression> operands, Boolean paren) {
        super(ClientOperation.LESS, operands, paren);
    }
