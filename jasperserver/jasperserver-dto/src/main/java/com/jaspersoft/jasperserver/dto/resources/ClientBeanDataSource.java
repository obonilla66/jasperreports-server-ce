...
public class ClientBeanDataSource extends ClientResource<ClientBeanDataSource> implements ClientReferenceableDataSource {
    ...
    public ClientBeanDataSource(ClientBeanDataSource other) {
        super(other);
        this.beanName = other.getBeanName();
        this.beanMethod = other.getBeanMethod();
    }
    ...
    @Override
    public ClientBeanDataSource deepClone() {
