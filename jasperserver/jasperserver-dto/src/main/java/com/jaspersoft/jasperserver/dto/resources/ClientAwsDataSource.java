...
public class ClientAwsDataSource extends AbstractClientJdbcDataSource<ClientAwsDataSource> {
    ...
    public ClientAwsDataSource(ClientAwsDataSource source){
        super(source);
        accessKey = source.getAccessKey();
        secretKey = source.getSecretKey();
        roleArn = source.getRoleArn();
        region = source.getRegion();
        dbName = source.getDbName();
        dbInstanceIdentifier = source.getDbInstanceIdentifier();
        dbService = source.getDbService();
    }
