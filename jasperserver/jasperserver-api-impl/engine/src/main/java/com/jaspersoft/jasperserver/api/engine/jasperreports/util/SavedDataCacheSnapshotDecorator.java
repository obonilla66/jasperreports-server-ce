 ...
 * @version $Id$
 */
public class SavedDataCacheSnapshotDecorator implements DataCacheSnapshot {

	private final DataCacheSnapshot decorated;
	
	public SavedDataCacheSnapshotDecorator(DataCacheSnapshot decorated) {
		this.decorated = decorated;
	}

	public DataSnapshot getSnapshot() {
		return decorated.getSnapshot();
	}
