 ...
 */
public class XlsxMetadataReportOutput extends AbstractReportOutput
{
	...
	public XlsxMetadataReportOutput()
	{
	}

	protected DataContainer export(
			...
			JasperPrint jasperPrint, Integer startPageIndex, Integer endPageIndex)
	{
		try {
			...
			SimpleXlsxMetadataReportConfiguration reportConfiguration = new SimpleXlsxMetadataReportConfiguration();
			...
			try {
				...
				SimpleXlsxMetadataExporterConfiguration exporterConfiguration = new SimpleXlsxMetadataExporterConfiguration();
