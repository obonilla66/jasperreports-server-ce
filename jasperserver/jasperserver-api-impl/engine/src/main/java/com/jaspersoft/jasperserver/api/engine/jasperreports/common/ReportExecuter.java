...
public interface ReportExecuter {
	...
	ReportUnitResult executeReportUnitRequest(ExecutionContext context, ReportUnitRequest request);
	
	ReportUnitResult executeTrialReportUnitRequest(ExecutionContext context, TrialReportUnitRequest request);
