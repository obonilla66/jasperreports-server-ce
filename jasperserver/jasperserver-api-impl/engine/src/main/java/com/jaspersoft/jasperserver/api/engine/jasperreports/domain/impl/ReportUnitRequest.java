...
public class ReportUnitRequest extends ReportUnitRequestBase
{
	...
	public ReportUnitRequest(String reportUnitUri, Map reportParameters)
	{
		...
		if (ThreadContext.get(FilterBy.USER_ID.name()) != null) {
			propertyMap = new HashMap<String, Object>();
			propertyMap.put(EngineServiceImpl.ReportExecutionStatus.PROPERTY_USERNAME, ThreadContext.get(FilterBy.USER_ID.name()));
		}
	}
