 ...
 * @version $Id$
 */
public  class RepoResourceLight implements IdedRepoObject, Serializable {
    /**
	 * 
	 */
    ...
    public RepoResourceLight(){}
    
    public static final RepoResourceLight fromRepoResource(RepoResource r){
    	RepoResourceLight result = new RepoResourceLight();
    	result.setId(r.getId());
    	result.setVersion(r.getVersion());
    	result.setCreationDate(r.getCreationDate());
    	result.setUpdateDate(r.getUpdateDate());
    	result.setName(r.getName());
    	result.setLabel(r.getLabel());
    	result.setDescription(r.getDescription());
    	result.parent = r.getParent();
    	result.setResourceType(r.getResourceType());
    	return result;
    }
    ...
    public final void copyFromClient(Object objIdent, PersistentObjectResolver resolver) {
        throw new IllegalStateException("RepoResourceLight objects intended to be read only. Use RepoResourceBase based hierarchy to save items");
    }
    ...
    public boolean equals(Object o) {
        ...
        RepoResourceLight that = (RepoResourceLight) o;
