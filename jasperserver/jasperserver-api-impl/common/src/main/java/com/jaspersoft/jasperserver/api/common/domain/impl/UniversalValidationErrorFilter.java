 ...
 * @version $Id$
 */
public class UniversalValidationErrorFilter implements ValidationErrorFilter,
		Serializable {

	private static final UniversalValidationErrorFilter INSTANCE = 
		new UniversalValidationErrorFilter();
	
	public static UniversalValidationErrorFilter getInstance() {
		return INSTANCE;
	}
