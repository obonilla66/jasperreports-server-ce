...
/**
   ...
   *               false = pause individual jobs in the input jobs list
   *
   * @deprecated Replaced by {@link ReportSchedulingService#pauseJobs(ExecutionContext, List, boolean)}.
   */
   ...
   * @param all    true = pause all jobs (disregard the input jobs list)
	 *             false = pause individual jobs in the input jobs list
   */
    List<Long> pauseJobs(ExecutionContext context, List<ReportJobIdHolder> jobs, boolean all);
	 ...
	 *               false = resume individual jobs in the input jobs list
	 *
	 * @deprecated Replaced by {@link ReportSchedulingService#resumeJobs(ExecutionContext, List, boolean)}.
	 *
	 */
   ...
   *
   */
  List<Long> resumeJobs(ExecutionContext context, List<ReportJobIdHolder> jobs, boolean all);
