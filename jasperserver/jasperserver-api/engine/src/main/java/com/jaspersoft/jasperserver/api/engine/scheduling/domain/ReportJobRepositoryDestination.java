...
public class ReportJobRepositoryDestination implements Serializable {
  ...
  public ReportJobRepositoryDestination(ReportJobRepositoryDestination dest) {
	...
	public void copyFromModel(ReportJobRepositoryDestinationModel repositoryDestinationModel) {
		if (repositoryDestinationModel.isFolderURIModified()) setFolderURI(repositoryDestinationModel.getFolderURI());
		if (repositoryDestinationModel.isSequentialFilenames()) setSequentialFilenames(repositoryDestinationModel.isSequentialFilenames());
		if (repositoryDestinationModel.isOverwriteFilesModified()) setOverwriteFiles(repositoryDestinationModel.isOverwriteFiles());
		if (repositoryDestinationModel.isOutputDescriptionsModified()) setOutputDescription(repositoryDestinationModel.getOutputDescription());
		if (repositoryDestinationModel.isTimestampPatternModified()) setTimestampPattern(repositoryDestinationModel.getTimestampPattern());
		if (repositoryDestinationModel.isSaveToRepositoryModified()) setSaveToRepository(repositoryDestinationModel.isSaveToRepository());
		if (repositoryDestinationModel.isDefaultReportOutputFolderURIModified() && repositoryDestinationModel.getDefaultReportOutputFolderURI() != null)
			setDefaultReportOutputFolderURI(repositoryDestinationModel.getDefaultReportOutputFolderURI());
		if (repositoryDestinationModel.isUsingDefaultReportOutputFolderURIModified())
			setUsingDefaultReportOutputFolderURI(repositoryDestinationModel.isUsingDefaultReportOutputFolderURI());
		if (repositoryDestinationModel.isOutputLocalFolderModified()) setOutputLocalFolder(repositoryDestinationModel.getOutputLocalFolder());
		if (repositoryDestinationModel.isOutputFTPInfoModified()) copyFTPInfo(repositoryDestinationModel.getOutputFTPInfoModel());
	}

	protected void copyFTPInfo(FTPInfoModel jobFTPInfoModel) {
		if (getOutputFTPInfo()== null) {
			setOutputFTPInfo(new FTPInfo());
			if (jobFTPInfoModel == null) return;
		}
		if (jobFTPInfoModel != null) getOutputFTPInfo().copyFromModel(jobFTPInfoModel);
		else setOutputFTPInfo(new FTPInfo());
	}
}
