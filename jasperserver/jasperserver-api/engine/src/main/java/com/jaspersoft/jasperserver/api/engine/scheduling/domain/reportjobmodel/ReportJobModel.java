...
public class ReportJobModel extends ReportJob {
	...
	public void setContentRepositoryDestinationModel(ReportJobRepositoryDestinationModel contentRepositoryDestination) {
        ...
        isContentRepositoryDestinationModified = true;
	}
     ...
     * @return true if the attribute has been modified
     */
    public boolean isContentRepositoryDestinationModified() { return isContentRepositoryDestinationModified; }

	public void setIsContentRespositoryDestinationModified(boolean isContentRespositoryDestinationModified) {
		this.isContentRepositoryDestinationModified = isContentRespositoryDestinationModified;
	}
