...
public class PermissionOverride {
	...
	public boolean equals(Object o) {
		...
		PermissionOverride that = (PermissionOverride) o;

		return overrideId != null ? overrideId.equals(that.overrideId) : that.overrideId == null;
	}

	@Override
	public int hashCode() {
		return overrideId != null ? overrideId.hashCode() : 0;
	}
}
