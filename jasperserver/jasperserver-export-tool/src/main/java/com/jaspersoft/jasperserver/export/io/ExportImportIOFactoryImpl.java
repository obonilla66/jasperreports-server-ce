...
public class ExportImportIOFactoryImpl implements ExportImportIOFactory {
	...
	public ImportInput createInput(Parameters parameters) {
		ImportInputFactory matchingFactory = getInputFactory(parameters);
	...
	private ImportInputFactory getInputFactory(Parameters parameters) {
	...
	public ExportOutput createOutput(Parameters parameters) {
		ExportOutputFactory matchingFactory = getOutputFactory(parameters);
	...
	private ExportOutputFactory getOutputFactory(Parameters parameters) {
