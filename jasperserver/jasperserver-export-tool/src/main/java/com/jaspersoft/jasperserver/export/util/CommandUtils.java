...
public class CommandUtils {
	...
	public static String requestPassword(final String msg) {
		Console console = System.console();

		return new String(console.readPassword(msg + ": "));
	}
	
	public static String requestConfirmedPassword(final String msg, final String confMsg) {
		Console console = System.console();
		return requestConfirmedPassword(console, msg, confMsg);
	}

	public static String requestConfirmedPassword(final Console console, final String msg, final String confMsg) {

		for (int tryN = 0; tryN < 3; tryN++) {
			final char[] value = console.readPassword(msg);
			if (value == null) {
				continue;
			}

			final char[] value2 = console.readPassword(confMsg);
			if (value2 == null) {
				continue;
			}

			final String keypasswd = new String(value);
			final String confirmedKeypasswd = new String(value2);
			if (keypasswd.equals(confirmedKeypasswd)) return keypasswd;
		}
