 ...
 * @version $Id$
 */
public class UnsupportedOperationErrorDescriptorException extends ErrorDescriptorException {
    public static final String ERROR_CODE_UNSUPPORTED_OPERATION = "operation.not.supported";
    public UnsupportedOperationErrorDescriptorException() {
        super();
        getErrorDescriptor().setErrorCode(ERROR_CODE_UNSUPPORTED_OPERATION);
    }
    public UnsupportedOperationErrorDescriptorException(String operation) {
