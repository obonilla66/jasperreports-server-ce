    ...
    alter table JIAdhocDataView 
       drop constraint FKg7peg7nx3m94onnjkuluvtl3o;

    alter table JIAdhocDataView 
       drop constraint FKmuqa9b9jrsee17jfw6pppm1ho;

    alter table JIAdhocDataView 
       drop constraint FKjyeqt92gxl0dxoa5lkf75yiwi;

    alter table JIAdhocDataViewBasedReports 
       drop constraint FKpk0usonjjc7np9td0hv6j7deu;

    alter table JIAdhocDataViewBasedReports 
       drop constraint FK4l78a5g4kembkvorbymim9ng1;

    alter table JIAdhocDataViewInputControl 
       drop constraint FKc6ue8x1g6fltqk5ke6inm3mml;

    alter table JIAdhocDataViewInputControl 
       drop constraint FKkiv278kuwgfvkbq3jcodp1hy0;

    alter table JIAdhocDataViewResource 
       drop constraint FK5pk4arpyfu6671xfecq51968c;

    alter table JIAdhocDataViewResource 
       drop constraint FK5qctuwjt04urra07jvsxpli1x;

    alter table JIAdhocReportUnit 
       drop constraint FKdqcwil8gqy3qgh9cr4dx3p1no;

    alter table JIAdhocReportUnit 
       drop constraint FKom4d2gy6ixe28dlwsbb4on7wt;
    ...
    alter table JIDashboardModel 
       drop constraint FKno3tso0jfqti1hhbl8c25n0ry;

    alter table JIDashboardModelResource 
       drop constraint FKay6k91x53147ricaco1bkq0n7;

    alter table JIDashboardModelResource 
       drop constraint FKlf6l6i2usj0a8dglfr86c73c7;

    alter table JIDataDefinerUnit 
       drop constraint FKh06lfl9tq7r7kufnt5xifgef4;
    ...
    alter table JIDomainDatasource 
       drop constraint FKa9yl52eu0t0gtdnhv92hw9ndi;

    alter table JIDomainDatasource 
       drop constraint FK5lm14amynuir6h7uc7dfx05t7;

    alter table JIDomainDatasource 
       drop constraint FK7bsk45qyalthk4lrcv4mxwa05;

    alter table JIDomainDatasourceBundle 
       drop constraint FKlr5ldt3fi8d9x6s1ey8xcctje;

    alter table JIDomainDatasourceBundle 
       drop constraint FKtr8knmhxriwomlt8nppn1k50m;

    alter table JIDomainDatasourceDSRef 
       drop constraint FKikqlpr2kfty5to5seufum9sep;
    ...
    alter table JIMondrianConnectionGrant 
       drop constraint FKdhgtynksn8sijhvtw07fnnmdr;

    alter table JIMondrianConnectionGrant 
       drop constraint FKc2150iiriy6lqukm7w7ax6vw1;
    ...
    drop table if exists JIAdhocDataViewInputControl cascade;

    drop table if exists JIAdhocDataViewResource cascade;

    drop table if exists JIAdhocReportUnit cascade;
    ...
    drop table if exists JIDashboardModel cascade;

    drop table if exists JIDashboardModelResource cascade;

    drop table if exists JIDataDefinerUnit cascade;
    ...
    drop table if exists JIDomainDatasource cascade;

    drop table if exists JIDomainDatasourceBundle cascade;
    ...
    drop table if exists JIMondrianConnectionGrant cascade;
    ...
    drop table if exists JIReportOptionsInput cascade;
    ...
    drop table if exists ProfilingRecord cascade;
