...
@EqualsAndHashCode(excludes = ["changedLibVersion"])
class FileDescriptor {
    ...
    FileDescriptor(String libName, String libVersion, String libSHA) {
        this.libName = libName
        this.libVersion = libVersion == "" ? "No version" : libVersion
        this.libSHA = libSHA
    }
    ...
    @Override
    String toString() {
        return "${libName}:${libVersion} SHA:${libSHA}"
    }
}
